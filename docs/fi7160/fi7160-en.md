...
There are many kinds of scanners; (You can read more about scanners [here](http://www.fujitsu.com/cn/services/)). In this guide, we’ll talk about two kinds of scanners from Fujitsu (???) that we like for BDRC work. These are: 
